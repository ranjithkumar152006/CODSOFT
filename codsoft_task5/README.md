...
Scanning image (High Precision)...
Detected 1 face(s) in the image.
Summary: 1 identified, 0 unknown.
People found: yuvedha

Saving processed image...
Enter a specific name for the output file (or press Enter for default): yuv
Success! Saved as: output\yuv.jpeg
Showing image window. Close the window or press any key to continue...
QThreadStorage: entry 1 destroyed before end of thread 0x25fea37c550
QThreadStorage: entry 0 destroyed before end of thread 0x25fea37c550
...
--- Snapshot Mode ---
Enter a name for this snapshot (or press Enter for timestamp): yuvedha
Snapshot saved to output\yuvedha.jpg
Continuing video feed...

Quitting via key press...
Camera released and windows closed.
QThreadStorage: entry 1 destroyed before end of thread 0x274a7581a30
QThreadStorage: entry 0 destroyed before end of thread 0x274a7581a30
...
People found: ranjith, yuvedha

Saving processed image...
Enter a specific name for the output file (or press Enter for default): yuve
Success! Saved as: output\yuve.jpeg
Showing image window. Close the window or press any key to continue...
QThreadStorage: entry 1 destroyed before end of thread 0x17ab0437880
QThreadStorage: entry 0 destroyed before end of thread 0x17ab0437880
...
# Execution Video
Watch the execution of face_recognition_AI here: 
Click here to view execution video :https://drive.google.com/file/d/1YBACBsAC-Ek3p6emHbJi87fYzWg9cIjH/view?usp=sharing 
